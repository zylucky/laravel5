...
class fangYuanXKReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $sql="select pname,fd_name,`Name`,Phone,Loupan_name,Loudong_name,Fanghao,Qianyuemianji,price,yuezujin,xsdj,xsyzj,ckzl,ckzlzj,QianyueDate,StartDate,EndDate,yjts,
...
zxsp, lpsort from v_fyxk ";
        ...
        $headerData=['区域','分区','联系人','电话','项目属性','楼盘','楼栋','房间号','面积','收购单价（元/㎡/天）',
            ...
            '预警天数','风险房变亏损房预警天数','免租期开始日','预警级别','装修状态','礼品等级'];
