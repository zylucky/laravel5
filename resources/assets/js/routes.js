...
var fk_permission ,fk_permission_user ,fk_permission_role ,fk_permission_per ,
    ...
    fk_jinggengReport,fk_projectReport,fk_projectSaleReport,fk_qdCompanyList,fk_commissionReport,fk_coreDataReport,fk_commissionAuditList,fk_approvalDump;
...
let routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {path:'/approvalDump', component: approvalDump, name: '佣金列表', hidden: fk_approvalDump},
