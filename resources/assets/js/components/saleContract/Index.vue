...
<script>
    import {getSaleContractList,removeSaleContract,confirmSaleContract,weiyueSaleContract,endSaleContract,jieyueSaleContract,dumpingPurchaseContract} from '../../api/api.js';
    export default {
        data() {
            return {
                filters: {
