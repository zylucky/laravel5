    ...
    <el-row>
        ...
        <el-form label-Weizhi="right" ref="brokerCompanyFrom" :rules="brokerCompanyFromRules" label-width="180px"
            ...
            <el-col :span="18">
                ...
                <el-row>
                    <el-col :span="16">
                        <el-form-item label="门店所属公司">
                            <el-select
                                    v-model="brokerCompanyFrom.parentid"
                                    filterable
                                    remote
                            ...
                            >
                                <el-option
                                        v-for="item in brokerCompanyFrom.options1"
                                        :key="item.value"
                                        :label="item.label"
                                        :value="item.value">
                                </el-option>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeOnSelect1(){
                var arr = this.brokerCompanyFrom.options1;
                console.log(this.brokerCompanyFrom.parentid)
                for (let i=0;i<arr.length;i++ ){
                    if(arr[i].value==this.brokerCompanyFrom.parentid){
                        this.brokerCompanyFrom.parent = arr[i].label;
            ...
            remoteMethod1(query) {
                ...
                getbkNameList(para).then((res) => {
                    ...
                    if (query !== '') {
                        ...
                        setTimeout(() => {
                            this.bkNameloading = false;
                            this.brokerCompanyFrom.options1 = this.list;
                        }, 200);
                    } else {
                        this.brokerCompanyFrom.options1 = [];
                    }
                });
