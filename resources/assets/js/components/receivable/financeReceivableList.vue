...
<template>
    <el-row >
        ...
        <el-dialog title="应收款列表" v-model="rokeBackFormVisible" :close-on-click-modal="false" size="large">
            ...
            <el-table height="300" :data="ReceivableJS" :row-class-name="tableRowClassName"
                      highlight-current-row v-loading="listLoading" @current-change="handleCurrentChange1" element-loading-text="拼命加载中"  >
