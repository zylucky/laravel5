            ...
            <div v-if="owner.yezhuleixing==1">
                <div v-for="(item, index) in owner.chanquanrenList">
                    ...
                    <el-row>
                        ...
                        <el-col :span="2">
                            <el-button v-if="btnShow" v-show="index>0" style="margin-left:6px;" @click.prevent="removeOwnerItem(item)">删除</el-button>
                        </el-col>
                    </el-row>
                </div>
                <el-form-item>
...
<script>
    import {optimizePurchaseContract,getOptimizePurchaseContract,youhuacgPurchaseContract,getPurchaseContractInfo} from  '../../api/api';
    export default{
        data(){
            return{
                editFormRules:{
        ...
        methods:{
            getContractInfo(){
                getPurchaseContractInfo({id:this.$route.query.hetongid}).then((res)=>{
                    //1.先计算面积综合
            ...
            perPrice(index,value){
                ...
                console.log(this.addDate.zujinList)
