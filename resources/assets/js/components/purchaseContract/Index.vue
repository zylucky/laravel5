                ...
                <template scope="scope">
                    <el-dropdown   menu-align="start">
                        ...
                        <el-dropdown-menu slot="dropdown" >
                            ...
                            <el-dropdown-item  v-if="ztin(scope.row,[0,1,2,4,5,6,])&&fun('purchaseContactUpdate')" ><el-button @click="handleEdit(scope.$index, scope.row)">编辑合同</el-button></el-dropdown-item>
                            ...
                            <el-dropdown-item  v-if="ztin(scope.row,[0,1,2,3])&&fun('purchaseContactDump')"><el-button @click="handleDump(scope.$index, scope.row)">打印合同</el-button></el-dropdown-item>
