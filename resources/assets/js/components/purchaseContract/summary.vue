    ...
    <div style="font-size: 12px;" class="summary">
        ...
        <div style="margin-left:18px;float: left">
            ...
            <table  style="border-collapse: collapse;">
                ...
                <tr>
                    <td  align="center" height="23" ><p style="display: inline;">{{data.zujins[1]?data.zujins[1].split(' ')[0]:''}}</p> <p style="display: inline;margin-left:15px;">{{data.zujins[1].split(' ')[1]}}</p> </td>
                    <th  align="left">保证金</th>
                    <td  align="center">¥{{toDecimal(data.baozhengjin)}}</td>
                </tr>
                <tr>
                    <td  align="center" height="23" ><p style="display: inline;">{{data.zujins[2]?data.zujins[2].split(' ')[0]:''}}</p> <p style="display: inline;margin-left:15px;">{{data.zujins[2].split(' ')[1]}}</p> </td>
