            ...
            <li v-for="officeList in officeList" style="list-style-type:none;" >
                <el-row>
                    ...
                    <el-col :span="0" style="margin-rigjt:0;float:right;margin-top:50;">
                        <el-button type="primary" v-if="fun('purchaseContactAppZHAdd')"  class="el-icon-plus" @click="addContract"> 新增</el-button>
                    </el-col>
                </el-row>
            </li>
        </el-row>
                ...
                <!--<if condition="laiyuantype eq 2">-->
                    ...
                    <el-table-column label="操作" width="300">
                        <template slot-scope="scope">
                                <el-button v-if="fun('purchaseContactAppZHEdit')"   type="primary" size="normal" splitButton="true" @click="editYHZH(scope.$index, scope.row)">
                                    编辑
                                </el-button>
                                <el-button v-if="fun('purchaseContactAppZHDel')"  type="primary" size="normal" splitButton="true" @click="handleDel(scope.$index, scope.row)">
                                    删除
                                </el-button>
                        </template>
                    </el-table-column>
